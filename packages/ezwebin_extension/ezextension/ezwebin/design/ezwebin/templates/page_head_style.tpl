...
<!--[if IE 5]>     <style type="text/css">/*<![CDATA[*/ @import url({"stylesheets/browsers/ie5.css"|ezdesign(no)});    /*]]>*/</style> <![endif]-->
<!--[if lte IE 7]> <style type="text/css">/*<![CDATA[*/ @import url({"stylesheets/browsers/ie7lte.css"|ezdesign(no)}); /*]]>*/</style> <![endif]-->