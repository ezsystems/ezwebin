...
<ul>
    ...
    <li>{'To edit this version create a copy of it.'|i18n( 'design/ezwebin/content/history' )}</li>
</ul>
</div>
{/case}
{case match=2}
...
<ul>
    ...
    <li>{'You can change your version history settings in content.ini, remove draft versions or edit existing drafts.'|i18n( 'design/ezwebin/content/history' )}</li>
</ul>
</div>
{/case}
{case}
...
<tr class="{$seq}">
	...
	<td>
	    ...
	    {else}
            <input type="checkbox" name="" value="" disabled="disabled" title="{'Version #%version_number can not be removed because it is either the published version of the object or because you do not have permissions to remove it.'|i18n( 'design/ezwebin/content/history',, hash( '%version_number', $version.version ) )}" />
        {/if}
    </td>
	...
	{/foreach}
        ...
        {else}
			<input type="image" src={'copy-disabled.png'|ezimage} name="" value="" disabled="disabled" title="{'You can not make copies of versions because you do not have permissions to edit the object.'|i18n( 'design/ezwebin/content/history' )}" />
        {/if}
	{undef $can_edit_lang}
    </td>
