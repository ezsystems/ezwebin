...
<input type="hidden" name="selectedINIFile" value="site.ini" />
...
{section show=or( $Blocks.key|eq('SiteSettings'),
                  $Blocks.key|eq('MailSettings') ) }
        <tr>
	    <!-- <th class="tight">&nbsp;</th> -->
            <th width="50%">
	        {$Blocks.key}
...
<!--	    <th class="tight">
    ...
    {section show=or( $Settings.key|eq('SiteName'),
                      $Settings.key|eq('SiteURL' ),
                      $Settings.key|eq('AdminEmail' ),
                      $Settings.key|eq('MetaDataArray' ) ) }
